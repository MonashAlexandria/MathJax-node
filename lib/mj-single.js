...
/*
 * tempfile must be unique and totally randomized, otherwise we will share this file across threads/processes
 * This will eventually slow down the work and potentially break the application if multiple threads/processes refer
 * to the same tempfile file.
 * */
var tmpfile = os.tmpdir() + "/mj-single-svg" +  process.pid + "-" + randomValueHex(12);  // file name prefix to use for temp files
...
/**
 * from: https://blog.tompawlak.org/generate-random-values-nodejs-javascript
 * @param len
 * @returns {string}
 */
